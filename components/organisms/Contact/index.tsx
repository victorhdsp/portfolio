        ...
        <section id="contato" className={css["root"]}>
            <div className={css["inner"]}>
                <div className={css["information"]}>
                    ...
                    >
                        <h2>Contato</h2>
                        <p>Se você quiser saber mais você pode entrar em contato comigo por e-mail ou através das minhas redes sociais ou baixar meu currículo em PDF.</p>
                        <Download href="/archives/curriculo-victor.pdf">
                            Baixar currículo
                        </Download>
                    </motion.div>
